...
void Simulation::calc_bg()
{
    ...
    if (source.continuum.type == Continuum::thermal)
        molsim::functional::calc_Ibg(spectrum.frequency, source.continuum.params, spectrum.Ibg);
    else
        molsim::functional::calc_Ibg(spectrum.frequency, spectrum.Tbg, spectrum.Ibg);
}
